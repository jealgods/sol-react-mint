            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-neutral-300 leading-relaxed text-sm">
                  ...
                  accessing or using our Services, you agree to the terms of
                  this Privacy Policy.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-neutral-300 leading-relaxed text-sm">
                  ...
                  your choice in Longlifecoin. It just gives you some medical
                  knowledge, using Longlifecoin is your choice, all
                  responsibility depends on you. Hua Tuo is only known to
                  Chinese people, and no one else knows him, so I must introduce
                  him to you. Hua Tuo is best famous doctor in china more than
                  thousand years we call Hua Tuo is Miracle Doctor. and his
                  method has 1000 years of history.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-3 text-neutral-300 space-y-0.5 text-xs">
                  ...
                  <li>
                    <span className="font-semibold">To Improve Services:</span>{" "}
                    To analyze usage trends, develop new features, and enhance
                    user experience.
                  </li>
                  <li>
                    <span className="font-semibold">For Security:</span> To
                    prevent fraud, detect unauthorized activities, and ensure
                    the safety of our users.
                  </li>
                  <li>
                    <span className="font-semibold">To Communicate:</span> To
                    send updates, promotional materials, and important
                    notifications about your account or our Services.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-3 text-neutral-300 space-y-0.5 text-xs">
                  <li>
                    ...
                    Third-party vendors who assist us in delivering Services,
                  ...
                  <li>
                    <span className="font-semibold">To Protect Rights:</span>{" "}
                    When necessary to enforce our Terms of Service, protect our
              ...
              <div>
                ...
                <p className="text-neutral-300 text-xs">
                  ...
                  credentials and promptly notifying us of any unauthorized
                  access.
                </p>
              </div>
